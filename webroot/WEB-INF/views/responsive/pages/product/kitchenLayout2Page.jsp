...
<template:page pageTitle="${pageTitle}">
	...
	<div class="container pdp-view--oserv">
		<cms:pageSlot position="SolutionCardsSlot" var="comp" element="div" class="row">
			<cms:component component="${comp}" element="div" class="col-12 col-lg-6"/>
		</cms:pageSlot>
	</div>
</template:page>
