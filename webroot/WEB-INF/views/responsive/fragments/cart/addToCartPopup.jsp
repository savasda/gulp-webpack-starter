...
<spring:message code="basket.added.to.basket" var="cartHeader"/>
{"quickOrderErrorData": [
...
"cartAnalyticsData":{"cartCode" : "${ycommerce:encodeJSON(cartCode)}","productPostPrice":"${ycommerce:encodeJSON(entry.basePrice.value)}","productName":"${ycommerce:encodeJSON(productName)}","addToCartTitle":"${ycommerce:encodeJSON(cartHeader)}"}
,
"addToCartLayer":"<spring:escapeBody javaScriptEscape="true" htmlEscape="false">
	<spring:htmlEscape defaultHtmlEscape="true">
	<spring:theme code="basket.added.to.basket" var="addToCartText"/>
	...
	<ycommerce:testId code="addToCartPopup">
		<div id="addToCartLayer" class="add-to-cart">
            ...
            <a href="" class="btn button-purple btn-block js-mini-cart-close-button">
