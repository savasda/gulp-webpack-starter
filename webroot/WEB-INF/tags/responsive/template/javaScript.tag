...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script><script src="https://unpkg.com/swiper/js/swiper.min.js"></script>
...
<c:choose>
	...
	<c:otherwise>
		...
		<%-- plugins --%>
		<script src="${commonResourcePathHtml}/js/krpano/krpano.js"></script>
		...
		<script src="${commonResourcePathHtml}/js/jquery.tabs.js"></script>
		...
		<script src="${commonResourcePathHtml}/js/jquery.magnific.js"></script>
		...
		<script src="${commonResourcePathHtml}/js/acc.krpano.js"></script>
		...
		<script src="${commonResourcePathHtml}/js/acc.filter.js"></script>
		...
		<script src="${commonResourcePathHtml}/js/custom/acc.owl-carusel.js"></script>
